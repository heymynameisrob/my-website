...
export const HomeBio = () => (
  ...
  >
    ...
    <p className="text-secondary">
      I design and build professional software. Mostly for early-stage startups,
      particularly in healthcare and life science - but also in B2B and
      ecommerce amongst others. Recently, I lead design at{" "}
      <a
