  ...
  return(
    <div className="fixed z-50 bottom-9 left-0 right-0 grid place-items-center pointer-events-none">
      ...
      className={cn(
        ...
        <div className={cn("w-full px-4 flex flex-col items-center justify-center flex-1 opacity-0 overflow-hidden", isOpen && "opacity-1")}>
          <ContactForm />                 
        </div>     
        <Button 
          ...
          className="w-full gap-2">
            ...
            {!isOpen && (<><DrawingPinFilledIcon /><small>Book Me</small></>)}            
          </Button>
      </motion.div>
    </div>
