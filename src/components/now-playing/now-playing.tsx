      ...
      <AnimatePresence mode="wait">
        {data?.isPlaying ? (
          <motion.div
            ...
            className={cn(
              "px-2 h-10 rounded-xl bg-background inline-flex flex-row items-center justify-between gap-2 dark:bg-ui",
          ...
          >
            ...
            >
              <Image
                ...
                width={24}
                height={24}
                className="rounded-md border border-background w-6 h-6"
              />
