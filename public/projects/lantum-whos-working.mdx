...
<Image src="/images/sww-2.png" width="1557" height="1473" title="Using a Segment control so clinicians could easy swap between their own shifts and the entire departments" />
...
<Image src="/images/sww-1.png" width="1557" height="1473" title="A chronological list view displayed the shifts by person with the shift time plus additional information e.g lables for allocation" />
...
<Image src="/images/sww-3.png" width="1557" height="1473" title="By default the display is the current week, but pulling down on the calendar exposes the entire month, exposing familiar mobile gestures ANIMATE ME!" />
...
<Image src="/images/sww-3.png" width="1557" height="1473" title="Multiple filters can be bundled together which covers multiple use cases" />

Finally, we explored different filtering options to help clincians find specific pieces of information. 
If you want to know who is on a night shift next Wednesday, these filters allow you to do that in a few taps. 

Ultimately we want the filters to be constructable so you can build powerful views, giving clincians the ability to customise Lantum to work exactly how they wanted.
