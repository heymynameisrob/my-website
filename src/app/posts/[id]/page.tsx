...
export default async function PostPage({ params }: { params: { id: string } }) {
  ...
  return (
    <>
      ...
      <div className="prose max-w-2xl mx-auto px-4 py-12 lg:py-20 z-10">
        <GridLine orientation="y" align="left" offset={32} />
        <div className="flex flex-col gap-2 mb-8 xl:mb-10">
          <h1 className="text-base tracking-[-0.011em] font-medium mb-0 xl:text-lg">
            {frontmatter.title}
          </h1>
          <time className="text-base text-secondary tracking-[-0.011em]">
